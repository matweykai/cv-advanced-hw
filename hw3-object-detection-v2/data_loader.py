...
if __name__ == '__main__':
    ...
    for i, (data, label, original_data) in enumerate(train_set):
...
# def draw(img, label, output_path):
#     """
#     Draw bounding boxes on an image and save to file
    
#     Args:
#         img: Tensor image in CxHxW format
#         label: YOLO format label tensor
...
#     ax.imshow(orig_img.permute(1, 2, 0).numpy())  # Convert from CxHxW to HxWxC for display
